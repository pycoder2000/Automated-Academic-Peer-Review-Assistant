...
import { FileText, Calendar, User, ExternalLink, CheckCircle, Clock, XCircle, AlertCircle } from 'lucide-react';
...
const ReviewPaperPage: React.FC<ReviewPaperPageProps> = ({ onBack, onViewPaper }) => {
